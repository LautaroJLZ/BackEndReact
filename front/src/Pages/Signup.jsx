...
const Signup = () => {
    return(
        <div className='h-screen flex justify-center items-center bg-gray-200'>
            <form className='flex flex-col bg-slate-100 shadow-gray-200 w-2/3 h-3/4 rounded-2xl justify-center items-center' action="">
                ...
                <button className='w-1/2 my-5 py-2 bg-gray-300 shadow-lg shadow-gray-500/30 text-black rounded-lg hover:bg-gray-500 hover:delay-75'>Iniciar</button>
            </form>
        </div>
    )
}
